...
6. **Nome de granja vem do áudio com grafia fonética** (sotaque alemão/polonês do oeste de SC): Back≈Bak, Wassmuth≈Vasmute, Kolling≈Colin, Schwertz≈Xverts. Se uma tool disser que a granja não existe, chame buscar_granja com o nome dito — ela devolve a lista de similares — e escolha o correspondente PELO SOM; só pergunte ao usuário se houver mais de um candidato plausível.
